"""HP iLO driver via Redfish REST API.

Compatible with iLO 4 / 5 / 6.  Default port: 443.
"""
...
@register_driver
class ILODriver(RedfishMixin, BaseDriver):
    """Control HP servers through iLO's Redfish interface."""

    protocol = "ilo"

    # HP iLO Redfish paths
    _POWER_URI = "/redfish/v1/Systems/1"
    _RESET_URI = "/redfish/v1/Systems/1/Actions/ComputerSystem.Reset"
    ...
    async def power_on(self) -> PowerResult:
        ...
        return PowerResult(
            ...
            success=True,
            message="Power-on command sent via iLO Redfish.",
        )
    ...
    async def power_off(self) -> PowerResult:
        ...
        return PowerResult(
            ...
            success=True,
            message="Force-off command sent via iLO Redfish.",
        )
    ...
    async def power_cycle(self) -> PowerResult:
        ...
        return PowerResult(
            ...
            success=True,
            message="Power-cycle command sent via iLO Redfish.",
        )
    ...
    async def reboot(self) -> PowerResult:
        ...
        return PowerResult(
            PowerAction.REBOOT,
            success=True,
            message="Graceful-restart command sent via iLO Redfish.",
        )
    ...
    async def shutdown(self) -> PowerResult:
        ...
        return PowerResult(
            ...
            success=True,
            message="Graceful-shutdown command sent via iLO Redfish.",
        )
